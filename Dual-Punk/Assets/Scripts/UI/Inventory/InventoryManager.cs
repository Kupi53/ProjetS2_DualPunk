...
public class InventoryManager : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        if (eventData.button == PointerEventData.InputButton.Left)
        {
            ...
            if (slot != null && slot.heldItem != null && slot.heldItem.GetComponent<InventoryItem>().Instance.tag != "Projectile")
            {
    ...
    public void SwapEquipedSlot(InventorySlots currentWeaponSlot, InventorySlots nextWeaponSlot)
    {
        ...
        if (nextStoredObject != null)
        {
            ...
            GameObject equipedObject = nextStoredObject.GetComponent<InventoryItem>().Instance;
...
//--------------------Auxilaries Functions that work as their name says.------------------------------------
    ...
    {
        bool res = false;
        string placedItemName = selectedItem.GetComponent<InventoryItem>().Instance.tag;
    ...
    private void Drop(InventorySlots slot)
    {
        ...
        if (slot.heldItem == null)
        {
            item = _draggedObject.GetComponent<InventoryItem>().Instance;
            destroyedInventoryItem = _draggedObject;
        }
        else
        {
            item = slot.heldItem.GetComponent<InventoryItem>().Instance;
        }
